...
class SignUpForm(UserCreationForm):
    email = forms.EmailField(label="", widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Email Address'})) # using 'class':'form-control' as we're styling with bootstrap
...
class AddRecordForm(forms.ModelForm):
    ...
    surname = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={'placeholder':'Surname','class':'form-control'}),label='')
